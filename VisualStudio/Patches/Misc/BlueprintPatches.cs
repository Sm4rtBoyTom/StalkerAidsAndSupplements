...
internal class BlueprintPatches
{
    ...
    internal static class UnlockOnNotePickUp
    {
        ...
        {
            if (gi == null || gi.name != "GEAR_NoteNaturalBandage") return;
            ...
            __instance.UnlockSilent(targetBlueprint); //if Unlock with notification - Notification appears on every scene load for some reason
        }
    }
}
