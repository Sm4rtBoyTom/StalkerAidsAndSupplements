    ...
    internal class UncookedJamPatches
    {
        internal static void Postfix(GearItem __instance)
        {
            if (__instance.name.Contains("GEAR_UncookedRosehipJam"))  
            {
                ...
                Cookable cook = __instance.gameObject.GetComponent<Cookable>() ?? __instance.gameObject.AddComponent<Cookable>();
                if (cook != null)
                {
         ...
         internal static void Postfix(GearItem __instance)
         {
             if (__instance.name.Contains("GEAR_SleepingPills"))
             {
                ...
                if (food != null)
                 ...
                 ConditionRestBuff Rest = __instance.gameObject.GetComponent<ConditionRestBuff>() ?? __instance.gameObject.AddComponent<ConditionRestBuff>();
                 if (Rest != null)
                 {
     ...
     internal class BottleCaffeine
     {
         internal static void Postfix(GearItem __instance)
         {
             if (__instance.name.Contains("GEAR_BottleCaffeine"))
             {
                 ...
                 FatigueBuff Fatigue = __instance.gameObject.GetComponent<FatigueBuff>() ?? __instance.gameObject.AddComponent<FatigueBuff>();
                 if (Fatigue != null)
                 {
                 ...
                 IngestedCarryCapacityBuff carryBuff = __instance.gameObject.GetComponent<IngestedCarryCapacityBuff>() ?? __instance.gameObject.AddComponent<IngestedCarryCapacityBuff>();
                 if (carryBuff == null)
                 {
                     carryBuff = __instance.gameObject.GetComponent<IngestedCarryCapacityBuff>() ?? __instance.gameObject.AddComponent<IngestedCarryCapacityBuff>(); 
                 }
    ...
    internal class EnergyDrink
    {
        internal static void Postfix(GearItem __instance)
        {
            ...
            if (__instance.name.Contains("GEAR_SodaEnergy")) //Some buff and tweaks to energy drink so it's not that useless
            {
                ...
                EnergyBoostItem energyBoost = __instance.gameObject.GetComponent<EnergyBoostItem>() ?? __instance.gameObject.AddComponent<EnergyBoostItem>();
                if (energyBoost != null)
                {
