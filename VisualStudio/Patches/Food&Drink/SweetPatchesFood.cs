...
{
    [HarmonyPatch(typeof(GearItem), "Awake")] //Patches for sweetened food to behave like vanilla counterparts but with extra features (litle more powerful than drinks)
