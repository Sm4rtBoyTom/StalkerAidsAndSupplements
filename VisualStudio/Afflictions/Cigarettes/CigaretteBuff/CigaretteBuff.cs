...
namespace StalkerAidsAndSupplementsMod.Afflictions.Buffs
{
    public class CigaretteBuff : CustomAffliction, IDuration, IInstance, IBuff, IRemedies
    {
    ...
    location: AfflictionBodyArea.Head)
        ...
        {
            float minutesRemaining = ((IDuration)this).GetTimeRemaining();
